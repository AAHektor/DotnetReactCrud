...
public class PeopleController : ControllerBase
{
    ...
    public async Task<IActionResult> AddPerson(Person person)
    {
        try
        {
            ...
            return CreatedAtRoute("GetPerson", new{id=person.Id}, person); // 201 Created status code + location of the resource + person object in the body
        }
        catch (Exception ex)
        {
    ...
    [HttpPut("{id:int}")] //POST /api/people/1
